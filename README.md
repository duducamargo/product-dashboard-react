...
Importante: a DummyJSON retorna o usuario criado com um novo `id`, mas nao persiste esse usuario no servidor e nao gera uma sessao autenticada automaticamente.
